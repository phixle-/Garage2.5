...
namespace Garage25.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SSN,FirstName,LastName")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SSN,FirstName,LastName")] Person person)
        {
            if (ModelState.IsValid)
            {
